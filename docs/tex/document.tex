...
%-------------------------------------------------
	...
	\colorbox{grey}{Scenariusz główny:}
	\begin{enumerate}
		\item Użytkownik wybiera opcję 'Personal Informations'.
...
%-----------------------------------------------
	...
	\begin{enumerate}
		...
		\item System zaznacza w widoczny sposób wybrany adres, ale nie ustawia go jako domyślny.
	...
	\begin{enumerate}\addtocounter{enumi}{6}
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				\item System wyświetla widok z komunikatem ostrzegawczym, oraz przycisakmi 'Yes', 'No'.
				\item Użytkownik klika 'Yes'.
...
\begin{enumerate}\addtocounter{enumi}{6}
	\item[]
	\begin{enumerate}
		\item[6.1.ii.1.] Użytkownik klika 'No'.
		\begin{enumerate}
			\item System ukrywa widok z komunikatem ostrzegawczym.
		\end{enumerate}
	\end{enumerate}
\end{enumerate}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|>{\columncolor[gray]{0.97}}p{4cm}| p{12cm} |}
			...
			& Sytemowowy            \\ \hline
			\textbf{Udziałowcy i cele}	
			& Użytkownik zaznacza opcję o nazwie kategorii, jaką
			powiniem spełniać szukany produkt, w podstronie z wynikami wyszukiwania. Sklep redukuje/rozszerza listę o pordukty spełniające warunki.           		\\ \hline
			\textbf{\begin{tabular}[l]{@{}l@{}}Zdarzenie \\ wyzwalające\end{tabular}} 	
	...
	\colorbox{grey}{Scenariusz główny:}
	\begin{enumerate}
		\item Klient wyszukuje produkt w wyszukiwarce.
		\item System przekierowywuje go do podstrony z listą rezultatów.
		\item Klient zaznacza opcję przy dostępnych kategoriach.
		\item System odświeża listę zostawiając tylko te produkty, które spełniają kryteria.
	\end{enumerate}
	%---------------------------------------	
	...
	\begin{enumerate}\addtocounter{enumi}{3}
		\item[]
		\begin{enumerate}
			\item Klienit odznacza opcję.
			\begin{enumerate}
				\item System odświeża listę, rozszerzając listę o produkty, które spełniają kryteria.
			\end{enumerate}
		\end{enumerate}
	\end{enumerate}
	%---------------------------------------
