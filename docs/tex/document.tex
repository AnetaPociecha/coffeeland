...
\chapter{Słownik danych}
	...
	%-------------------------------------------------------
	%-------------------------------------------------------
		\paragraph{country} $=$ 1-20 liter
		\paragraph{city} $=$  1-20 liter
		\paragraph{street} $=$ 1-20 liter
		\paragraph{ZIPCode} $=$ <cyfra><cyfra>-<cyfra><cyfra><cyfra>
		\paragraph{Building number} $=$ 1-4 cyfry
		\paragraph{Apartament number} $=$ 1-4 cyfry
